...
This project is designed according to the requirements mentioned in Lab Assignment 2.
It showcases clean OOP structure while keeping everything in one Java file for easy compilation.
